...
@PrepareForTest({ Paging.class, Query.class, QueryResult.class,
		GeoLocation.class, GeoQuery.class, CommandDumpSimilarPlaces.class,
		BaseCommand.class })
public class TsakUnitTest {
	...
	public void setup() throws Exception {
		...
		PowerMockito.whenNew(GeoLocation.class)
				.withArguments(testLatitude, testLongitude)
	...
	public void testCase_1() throws TwitterException {
		...
		TsakResponse expected = new TsakResponse(0, new ArrayList<IDs>(
				Arrays.asList(ids)));
	...
	public void testCase_3() throws TwitterException {
		...
		Mockito.when(locationsList.getRateLimitStatus()).thenReturn(
				rateLimitStatus);
		Mockito.when(rateLimitStatus.getRemaining()).thenReturn(0);
	...
	public void testCase_4() throws TwitterException {
		...
		Mockito.when(blockList.getRateLimitStatus())
				.thenReturn(rateLimitStatus);
		Mockito.when(rateLimitStatus.getRemaining()).thenReturn(0);
	...
	public void testCase_6() throws TwitterException {
		...
		Mockito.when(statusList.getRateLimitStatus()).thenReturn(
				rateLimitStatus);
		Mockito.when(rateLimitStatus.getRemaining()).thenReturn(0);
	...
	public void testCase_7() throws TwitterException {
		...
		Mockito.when(twitter.getFollowersList(testUserId, -1)).thenReturn(
				userPagableList);
		Mockito.when(userPagableList.getRateLimitStatus()).thenReturn(
				rateLimitStatus);
	...
	public void testCase_9() throws TwitterException {
		...
		Mockito.when(twitter.getFriendsList(testUserId, -1)).thenReturn(
				userPagableList);
		Mockito.when(userPagableList.getRateLimitStatus()).thenReturn(
				rateLimitStatus);
		Mockito.when(userPagableList.getNextCursor()).thenReturn(0L);
	...
	public void testCase_12() throws TwitterException {
		...
		TsakResponse expected = new TsakResponse(0,
				IncomingFriendshipsCollection);
		expected.setCommandDetails(testCommand.toString());
	...
	public void testCase_14() throws Exception {
		...
		Mockito.when(twitter.getMemberSuggestions(testSlug)).thenReturn(
				userRList);
		Mockito.when(userRList.getRateLimitStatus())
				.thenReturn(rateLimitStatus);
		Mockito.when(rateLimitStatus.getRemaining()).thenReturn(0);
	...
	public void testCase_24() throws Exception {
		...
		Mockito.when(twitter.getSavedSearches()).thenReturn(
				savedSearchResponseList);
		Mockito.when(savedSearchResponseList.getRateLimitStatus()).thenReturn(
				rateLimitStatus);
		Mockito.when(rateLimitStatus.getRemaining()).thenReturn(0);
	...
	//
	// CommandDumpSimilarPlaces testCommand = new CommandDumpSimilarPlaces();
	// testCommand.setHelp(true);
	// testCommand.setOutputFile(testOutput);
	// testCommand.setPlaceName(testPlaceName);
	// testCommand.setLatitude(testLatitude);
	// testCommand.setLongitude(testLongitude);
	//
	//
	//
	//
	// TsakResponse expected = new TsakResponse(0, placeResponseList);
	// expected.setCommandDetails(testCommand.toString());
	// PowerMockito.whenNew(GeoLocation.class).withArguments(testLatitude,
	// testLongitude).thenReturn(geoLocation);
	// Mockito.when(twitter.getSimilarPlaces(geoLocation, testPlaceName, null,
	// null)).thenReturn(placeResponseList);
	// Mockito.when(placeResponseList.getRateLimitStatus()).thenReturn(
	// rateLimitStatus);
	// Mockito.when(rateLimitStatus.getRemaining()).thenReturn(0);
	// TsakResponse result = testCommand.execute(twitter);
	//
	...
	public void testCase_27() throws Exception {
		...
		Mockito.when(categoryResponseList.getRateLimitStatus()).thenReturn(
				rateLimitStatus);
		Mockito.when(rateLimitStatus.getRemaining()).thenReturn(0);
