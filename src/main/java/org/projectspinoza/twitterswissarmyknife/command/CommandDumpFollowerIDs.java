...
public class CommandDumpFollowerIDs extends BaseCommand {
	...
	public TsakResponse execute(Twitter twitter) throws TwitterException {
        ...
        long cursor = -1;
        do {
            IDs ids = getScreenName() != null ? twitter.getFollowersIDs(getScreenName(), cursor)
                    : twitter.getFollowersIDs(this.getUserId(), cursor);
	...
	public String toString() {
		return "CommandDumpFollowerIDs [screenName=" + screenName + ", userId=" + userId + ", limit=" + limit + "]";
	}
}
